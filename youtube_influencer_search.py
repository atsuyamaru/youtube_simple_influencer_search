...
# Min Subscribers
min_subscriber_num = st.sidebar.number_input(label="Min Subscribers", min_value=0, max_value=None, value=1000, step=100)
# Max Subscribers
max_subscriber_num = st.sidebar.number_input(label="Max Subscribers", min_value=0, max_value=None, value=1_200_000, step=100)
